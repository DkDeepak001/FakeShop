...
function Login() {
  ...
  return (
   <>{
    !localStorage.getItem("verifiedToken") && !localStorage.getItem("token")?
   <div className='login-container'>
   <div className="card">
<form>
 <h2 className="title"> Log in</h2>
 <p className="subtitle">Don't have an account? <Link to="/signup"><a href="#" className='link' > sign Up</a></Link></p>
